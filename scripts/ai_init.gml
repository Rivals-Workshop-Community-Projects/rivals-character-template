// ai_init.gml
// https://rivalslib.com/workshop_guide/programming/reference/scripts/ai_scripts.html#ai-init-gml
// Initializes any variables your ai needs. Doesn't need to be just attacka arrays.
